Search engine that gets phrase query even with boolean operators and apply text tokenization , stemming  and returns documents match text with information 
